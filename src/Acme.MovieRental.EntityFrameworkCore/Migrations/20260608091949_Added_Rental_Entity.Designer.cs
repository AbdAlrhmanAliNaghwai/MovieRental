...
namespace Acme.MovieRental.Migrations
{
    ...
    [Migration("20260608091949_Added_Rental_Entity")]
    partial class Added_Rental_Entity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.MovieRental.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Acme.MovieRental.Directors.Director", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Acme.MovieRental.Movies.Movie", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Acme.MovieRental.Rentals.Rental", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Acme.MovieRental.Movies.Movie", b =>
                {
                    b.HasOne("Acme.MovieRental.Directors.Director", "Director")
                        .WithMany()
            ...
            modelBuilder.Entity("Acme.MovieRental.Rentals.Rental", b =>
                {
                    b.HasOne("Acme.MovieRental.Customers.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Acme.MovieRental.Movies.Movie", "Movie")
                        .WithMany()
