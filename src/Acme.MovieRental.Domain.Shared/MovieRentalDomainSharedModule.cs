...
public class MovieRentalDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        MovieRentalGlobalFeatureConfigurator.Configure();
        MovieRentalModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<MovieRentalDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<MovieRentalResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/MovieRental");

            options.DefaultResourceType = typeof(MovieRentalResource);
        ...
        {
            options.MapCodeNamespace("MovieRental", typeof(MovieRentalResource));
        });
    }
}
