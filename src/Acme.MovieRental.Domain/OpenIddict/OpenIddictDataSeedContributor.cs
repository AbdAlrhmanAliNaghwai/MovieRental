...
namespace Acme.MovieRental.OpenIddict;
...
public class OpenIddictDataSeedContributor : OpenIddictDataSeedContributorBase, IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateScopesAsync()
    {
        ...
        {
            Name = "MovieRental", 
            DisplayName = "MovieRental API", 
            Resources = { "MovieRental" }
        });
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var appClientId = configurationSection["MovieRental_App:ClientId"];
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["MovieRental_Swagger:ClientId"];
